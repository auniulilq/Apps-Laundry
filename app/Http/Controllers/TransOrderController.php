...
class TransOrderController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('order.form_order', compact('title', 'code', 'customers', 'services', 'orders'));
    ...
    public function getOrders()
{
    ...
    public function pickup(request $request,$id)
    {
        ...
        $order = TransOrders::find($id);

        // Update the order's status to indicate it has been picked up.
        // You may need to adjust the status value (e.g., 1, 'picked_up')
        // to match your application's logic.
        $order->order_status = 1;
        $order->save();

        // Display a success message using SweetAlert and redirect.
